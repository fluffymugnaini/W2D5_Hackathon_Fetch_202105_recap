...
const mbLotrMapping = [
  ...
  { MB: "ISTJ", name: "Aragorn", ID: "5cd99d4bde30eff6ebccfbe6", IMG: "https://static.wikia.nocookie.net/lotr/images/b/b6/Aragorn_profile.jpg", blurb: "Most characters seem to have fairly consistent personalities between the books and the films. Aragorn may be an exception. It has been a while since I read Lord of the Rings, but I think if I was typing Aragorn from the books he might be an extravert. I’ve also seen the film version typed as an INTJ, an ISFx, and an ISxP.  Introverted Sensing (Si) is an ISTJ’s first function. Like ESTJs, this makes them interested in preserving old ways of doing things and resistant to change. For Aragorn, you can see this in his conflict about whether to take his rightful place as king or leave things the way they are. As an auxiliary function,Extroverted thinking (Te) manifests itself as a tendency for ISTJs to think out loud and share their ideas and plans. They like order and control, and this helps make Aragorn an efficient and effective leader." },

...
function characterInformation(characterObject) {
  ...
  function postResults(data, dataInfo) {
    ...
    function play() {
      var audio = new Audio("Many_Meetings.mp3");
      audio.play();
    }
    play()
